...
def convert_points_to_3d(trajectory_center, trajectory_inner_rear_wheel, trajectory_outer_rear_wheel, depth_value=1.0):
    
    # Assuming trajectory_points is a list of 2D points [(x1, y1), (x2, y2), ...]
